...
const ProjectPreview: FC<projectPreviewProps> = ({ projectData }) => {
  ...
  return (
    <div className="grid place-items-center w-full h-full">
      ...
      >
        <div
          className={`relative w-full h-full transition-transform duration-700 preserve-3d shadow-2xl  shadow-secondary-500-25 border border-primary-200 bg-primary-100 dark:border-primary-900 dark:bg-primary-1000`}
        >
          <div
            className={`${cardClass} 
                bg-primary-100 text-primary-900
               dark:bg-primary-1000 dark:text-primary-100
            `}
          >
